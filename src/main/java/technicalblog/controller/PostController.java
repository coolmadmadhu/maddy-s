...
import technicalblog.model.categories;
...
public class PostController {
    ...
    public String createPost(Post newPost, HttpSession session) {
        ...
        {
            categories springBlogCategory=new categories();
    ...
    public String editPostSubmit(@RequestParam(name="postId") Integer postId, Post updatedPost, HttpSession session) {
        ...
        if(updatedPost.getJavaBlog()!=null) {
            categories javaBlogCategories=new categories();
            javaBlogCategories.setCategory(updatedPost.getJavaBlog());
            updatedPost.getCategories().add(javaBlogCategories);
        }
